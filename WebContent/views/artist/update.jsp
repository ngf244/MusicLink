...
<body>
    ...
    <section style="z-index: 1;">
		...
		<div id="contentArea">
			<div id="table_show">
			<form method="post" action="updateAction.jsp?CM_CODE=<%= CM_CODE %>">
				<table id="inputTable">
					<tr>
						<td class="board_title labeltd">제목</td>
						<td class="board_title">
							<input type="text" class="form-control input-default inputboard" placeholder="제목을 입력해주세요" name="title" value="<%= community.getCM_TITLE() %>">
						</td>
					</tr>
					<tr>
						<td class="board_content labeltd">내용</td>
						<td class="board_content">
							<textarea class="form-control h-150px inputtextarea" rows="10" placeholder="내용을 입력해주세요" name="content"><%= community.getCM_CONTENT() %></textarea>
						</td>
					</tr>
					<tr>
						<td></td>
