...
<style>
    ...
    .requestBox-li4{position: absolute; width: 60%; height: 20%; left: 35%; top: 25%; border: groove;}
    .requestBox-li5{position: absolute; width: 60%; height: 20%; left: 35%; top: 50%; border: groove;}
